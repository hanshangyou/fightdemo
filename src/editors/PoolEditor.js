import { RARITY, getCharacterPool, saveCharacterPool, resetCharacterPool } from '../systems/GachaSystem.js';
import { DEFAULT_CHARACTER_POOL } from '../config/DefaultCharacterPool.js';
import { getWeaponPool } from '../systems/WeaponSystem.js';
...
export class PoolEditor {
            ...
            <div class="editor-modal" id="editor-modal" style="display:none;">
                <div class="modal-content">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group">
                            <label>力量</label>
                            <input type="number" id="edit-str" min="1" max="999">
                        </div>
                        <div class="form-group">
                            <label>敏捷</label>
                            <input type="number" id="edit-dex" min="0" max="999">
                        </div>
                        <div class="form-group">
                            <label>体质</label>
                            <input type="number" id="edit-con" min="6" max="20">
                        </div>
                        <div class="form-group">
                            <label>速度</label>
            ...
            return `
                <div class="pool-item" data-id="${char.id}" style="border-color: ${rarity.color}">
                    ...
                    <div class="pool-item-stats">
                        ...
                        <span>💪${char.baseStats.str}</span>
                        <span>🏃${char.baseStats.dex}</span>
                        <span>🧬${char.baseStats.con}</span>
    ...
    showAddModal() {
        ...
        document.getElementById('edit-str').value = 20;
        document.getElementById('edit-dex').value = 5;
        document.getElementById('edit-con').value = this.getConFromHp(100);
    ...
    showEditModal(id) {
        ...
        document.getElementById('edit-str').value = char.baseStats.str;
        document.getElementById('edit-dex').value = char.baseStats.dex;
        document.getElementById('edit-con').value = char.baseStats.con ?? this.getConFromHp(char.baseStats.maxHp);
    ...
    saveCharacter() {
        ...
        const str = parseInt(document.getElementById('edit-str').value) || 20;
        const dex = parseInt(document.getElementById('edit-dex').value) || 5;
        const conInput = parseInt(document.getElementById('edit-con').value);
        ...
        const charData = {
            ...
            baseStats: {
                ...
                str: Math.max(1, Math.min(999, str)),
                dex: Math.max(0, Math.min(999, dex)),
                con: Math.max(6, Math.min(20, Number.isFinite(conInput) ? conInput : this.getConFromHp(hp))),
